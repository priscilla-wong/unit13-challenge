...
def get_investment_recommendation(risk_level):
    """
    Returns initial investment recommendation based on the risk profile.
    """
    risk_levels = {
...
def validate_data(age, investment_amount, intent_request):
    ...
    # Default retirement is 65 in this case.
    if age is not None:
        age = parse_int(
            age
        )  # Cast values because input will be string
        if age < 0:
    ...
    # Investment amounts need to be 5000 or greater
...
def recommend_portfolio(intent_request):
    """
    Dialogue and recommendation for portfolio based on user input.
    """
...
### YOUR FINAL INVESTMENT RECOMMENDATION CODE STARTS HERE ###
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            based on your chosen risk level, my recommendation is to choose a portfolio with {}
            """.format(
